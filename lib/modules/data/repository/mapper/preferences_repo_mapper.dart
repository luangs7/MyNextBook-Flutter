...
class PreferencesRepoMapper {
  AppPreferencesRepo toRepo(AppPreferences model) {
    return AppPreferencesRepo(isEbook: model.isEbook, keyword: model.keyword, isPortuguese: model.isPortuguese, subject: model.subject);
  }

  AppPreferences toDomain(AppPreferencesRepo model){
    return AppPreferences(isEbook: model.isEbook, keyword: model.keyword, isPortuguese: model.isPortuguese, subject: model.subject);
  }
}